...
<nav x-data="{ open: false }" class="fixed top-0 left-0 right-0 md:left-10 md:right-10 text-white flex justify-between bg-gray-400 items-center px-5 py-3  bg-opacity-50 backdrop-blur-xl shadow-lg rounded-lg mx-auto z-50">
