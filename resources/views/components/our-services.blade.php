...
<div class="mt-12 py-1.5">
    ...
    <div class="flex flex-col gap-14 justify-center items-center mx-4 sm:flex-row sm:flex-wrap md:flex-row sm:gap-8 md:gap-16">
        ...
        <div class="max-w-sm lg:w-1/4 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 px-2 py-4 lg:max-h-54 xl:max-h-96 ">
            <a href="#">
                <img class="object-contain rounded-t-lg w-96 h-44" src="{{ asset('storage/images/save.png') }}" alt="" />
            </a>
            <div class="p-5">
                <a href="#">
        ...
        <div class="max-w-sm lg:w-1/4 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 px-2 py-4 lg:max-h-54 xl:max-h-96 ">
            <a href="#">
                <img class="object-cover rounded-t-lg w-96 h-44" src="{{ asset('storage/images/ctc2.png') }}" alt="" />
            </a>
            <div class="p-5">
                <a href="#">
        ...
        <div class="max-w-sm lg:w-1/4 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 px-2 py-4 lg:max-h-54 xl:max-h-96">
            <a href="#">
                <img class="object-contain rounded-t-lg w-96 h-44" src="{{ asset('storage/images/make1.png') }}" alt="" />
            </a>
            <div class="p-5">
                <a href="#">
