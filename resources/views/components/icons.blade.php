<div class="sm:flex items-center justify-center min-h-[50vh] bg-white ">
    <div class="flex flex-col md:flex-row justify-center items-center space-y-8 md:space-y-0 md:space-x-28">
            ...
            <div class="text-center ">
                ...
                <p class="text-gray-500 text-sm mt-2 mb-4">Ju mund t'i raportoni<br>personat e papërgjegjshëm</p>
            </div>
        </div>
    </div>
