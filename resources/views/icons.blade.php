...
<body class="bg-gray-100 flex justify-center items-center min-h-screen p-4">
    <div class="flex flex-col md:flex-row justify-center items-center space-y-8 md:space-y-0 md:space-x-28">
        <div class="text-center">
            ...
            <p class="text-gray-500 text-sm text-lg mt-2">Verifiko profilin për ta rritur<br>besueshmërinë në komunitet</p> 
        </div>

        <div class="text-center">
            <svg xmlns="http://www.w3.org/2000/svg" width="57" height="57" viewBox="0 0 24 24" fill="none" stroke="url(#starGradient)" stroke-width="1" stroke-linecap="steepest" stroke-linejoin="round" class="w-16 h-16 mx-auto">
                <defs>
            ...
            <p class="text-gray-500 text-sm  text-lg mt-2">Vlerësoni bashkudhëtarët <br> pas cdo udhëtimi <br></p> 
        </div>
        ...
        <div class="text-center">
            ...
            <p class="text-gray-500 text-sm  text-lg mt-2">Ju mund t'i raportoni<br>personat e papërgjegjshëm</p>
        </div>
    </div>
</body>
</html>
