<x-app-layout>
    ...
    class="relative rounded-lg flex flex-col h-full overflow-y-auto max-h-[calc(80vh-100px)] 
    text-gray-700 bg-white shadow-lg w-full mb-8">
                   ...
                   <template x-for="user in filteredUsers()" :key="user.id">
                       <tr class="bg-gray-100">
                           <td class="border-b border-slate-200 py-5 px-6">
                               <div class="w-14 h-14 sm:w-16 sm:h-16 md:w-20 md:h-20 flex justify-center items-center">
                           ...
                           <td class="p-4 border-b border-slate-200" x-text="`${user.name || ''} ${user.lastname || ''}`"></td>
                           <td class="p-4 border-b border-slate-200" x-text="user.phone || ''"></td>
                           <td class="p-4 border-b border-slate-200" x-text="user.city || ''"></td>
                           <td class="p-4 border-b border-slate-200" x-text="user.email || ''"></td>
                           <td class="p-4 border-b border-slate-200" x-text="formatDate(user.created_at) || ''"></td>
                           <td class="p-4 border-b border-slate-200" x-text="user.is_super_admin == 1 ? 'Yes' : 'No'"></td>
