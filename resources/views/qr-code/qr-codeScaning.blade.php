<x-app-layout>
    <div class="container mx-auto p-8">
        <h1 class="text-3xl font-extrabold text-center text-white mb-8">{{ __('messages.Scan QR-Code') }}</h1>
        <div class="section ring-4 ring-customgreen-600 bg-gradient-to-br from-purple-100 via-blue-100 to-indigo-100 p-8 rounded-2xl shadow-lg border-2 border-white">
