<x-app-layout>
    <div class="container mx-auto p-3 md:p-7">
        ...
        <div class="section ring-4 ring-blue-500 bg-gradient-to-br from-purple-100 via-blue-100 to-indigo-100 p-2 md:p-8 rounded-2xl shadow-lg border-2 border-white">
