    ...
    <div class="bg-showImage bg-no-repeat bg-cover bg-center min-h-screen p-[15px]"> 
        ...
        <form action="{{ route('bookings.reserve') }}" method="POST"  class="bg-gray-200  bg-opacity-80 rounded-2xl m-5  p-2  md:mb-5 md:mx-24 ">
            ...
            <div class="flex justify-between items-center space-x-4">
                <p class="w-4/5 text-sm md:text-md ">  {{ __('messages.If you want to reserve your seat and pay in person, choose the "Reserve Your Seat" option. This allows you to secure your seat now and handle payment conveniently when you arrive.') }}</p>
                @if ($available_seats > 0)
