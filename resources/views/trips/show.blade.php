            ...
            <div class="flex my-2 text-black text-xl capitalize space-x-6 justify-between">
                ...
                <div class="text-black  space-y-1 justify-between ">    
                    ...
                    @if ($trip->users->image)
                        ...
                        />
                    @else
                        <img class="relative inline-block h-10 w-10  object-cover object-center" src="{{ asset('https://eu.ui-avatars.com/api/' . $trip->users->name  . '+' . $trip->users->lastname) }}" alt="Default Image">
                    @endif
