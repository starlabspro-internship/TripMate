<x-app-layout>
    <div class=" min-h-screen">
       <div class="container mx-auto px-4 py-6 ">
        <h1 class="text-3xl font-bold text-white p-6"> {{ __('messages.Rides Of') . ' ' . auth()->user()->name }}</h1>
            ...
            @forelse ($bookings->filter(fn($booking) => $booking->trip) as $booking)
                <div class="bg-white shadow-md rounded-lg border border-gray-200 overflow-hidden max-w-4xl mx-auto" data-status="{{ $booking->status }}">
                    <div class="flex justify-between items-center p-4 cursor-pointer bg-gray-50 " onclick="toggleDetails(this)">
                       ...
                       <!-- Destination -->
                       <div class="flex flex-col flex-grow pl-4 mt-2">
                        <div class="flex items-center gap-2">
                            <h3 class="text-xl font-medium text-gray-900 flex items-center gap-2 mb-1">
                                {{ $booking->trip->origincity->name }}
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-orange-500" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <svg height="24" preserveAspectRatio="xMinYMin" viewBox="-2 -2 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
                            <path d="m10 20c-5.523 0-10-4.477-10-10s4.477-10 10-10 10 4.477 10 10-4.477 10-10 10zm0-2a8 8 0 1 0 0-16 8 8 0 0 0 0 16zm0-10a1 1 0 0 1 1 1v5a1 1 0 0 1 -2 0v-5a1 1 0 0 1 1-1zm0-1a1 1 0 1 1 0-2 1 1 0 0 1 0 2z"/>
                        </svg>
                        ...
                        <div class="flex  justify-center p-0 -mb-3">
                            ...
                            <div class="w-full md:w-1/2  ">
                                <ol class="relative border-s border-teal-900 dark:border-teal-700 ml-16 mt-4">
                                    ...
                                    <li class="mb-5 ms-6">
                                        ...
                                        <h3 class="mb-1 text-sm text-gray-500  ml-3">{{ __('messages.Driver') }}:</h3>
                                        <p class="text-sm  text-gray-900  ml-3">{{ $booking->trip->users->name }} {{ $booking->trip->users->lastname }}</p>
                                    </li>
                                    <li class="mb-5 ms-6">
                                        <span class="absolute flex items-center justify-center w-8 h-8 bg-gray-100 rounded-full -start-4 ring-4 ring-customgreen-500">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="flex-shrink-0 ml-0" width="24px" height="24px" viewBox="0 0 24 24" fill="none">
