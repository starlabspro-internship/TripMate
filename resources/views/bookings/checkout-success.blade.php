    ...
    <div class=" flex items-center justify-center mt-28">
        <div class="max-w-7xl w-full p-6 bg-green-100 border-l-4 border-green-500 text-green-700 rounded-lg shadow-lg mx-4 sm:mx-8 md:mx-12">
            <div class="flex items-center justify-center space-x-4">
                ...
                <div>
                    <h1 class="text-3xl font-semibold text-center">Payment Successful!</h1>
                    <p class="mt-2 text-lg text-center">Your booking has been confirmed.</p>
                </div>
            </div>
            @if ($booking)
                <div class="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div class="p-4 border border-green-300 rounded-lg">
                        <div class="flex items-center space-x-2">
                            ...
                            <h3 class="text-xl font-medium">Passenger Information</h3>
                        </div>
                    ...
                    <div class="p-4 border border-green-300 rounded-lg">
                        <div class="flex items-center space-x-2">
                            ...
                            <h3 class="text-xl font-medium">Trip Information</h3>
                        </div>
                        <div class="mt-4 text-sm space-y-2">
                    ...
                    <div class="p-4 border border-green-300 rounded-lg">
                        <div class="flex items-center space-x-2">
                            ...
                            <h3 class="text-xl font-medium">Booking Information</h3>
                        </div>
                        <div class="mt-4 text-sm space-y-2">
