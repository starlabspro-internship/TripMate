<x-app-layout>
    <div class="justify-center flex mt-20 mb-10">
        <div class="bg-white shadow-md rounded-lg p-6 w-1/2">
            <h2 class="text-xl font-semibold text-customgreen-500 mb-4 text-center">{{ __('messages.Upload and Preview Document') }}</h2>
            <div id="drop-area"
                 class="border-dashed border-2 border-customgreen-500 bg-[#d4e9ee] rounded-lg py-12 text-center hover:bg-[#c9dde2] transition">
            ...
            <div class="flex flex-col lg:flex-row lg:justify-center mt-4 gap-4">
                <!-- Upload Button -->
                <button 
                    type="submit" 
                    class="w-full lg:w-auto px-8 flex items-center justify-center border bg-gradient-to-r from-customgreen-400 via-customgreen-500 to-customgreen-600 hover:bg-gradient-to-br text-white text-base py-2 rounded-lg tracking-wide font-medium cursor-pointer transition ease-in duration-500" 
                    onclick="showChangeFileButton()">
                    {{ __('messages.Upload') }}
                </button>
