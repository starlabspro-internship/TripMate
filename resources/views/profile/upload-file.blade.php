<x-app-layout>
    <div class="justify-center flex mt-20 mb-10">
        <div class="bg-white shadow-md rounded-lg p-6 w-1/2">
            <h2 class="text-xl font-semibold text-gray-800 mb-4 text-center">Upload and Preview Document</h2>
            <div id="drop-area"
                 class="border-dashed border-2 border-blue-800 bg-gray-100 rounded-lg py-12 text-center hover:bg-gray-200 transition">
                <p class="text-gray-600 font-medium">Upload your file here or</p>
                ...
                <p class="mt-2 text-sm text-gray-500">Supported formats: JPG, PNG, PDF. Max size: 25MB</p>
            </div>
