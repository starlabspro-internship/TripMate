<x-app-layout>
    <div class="min-h-screen bg-animation flex items-center justify-center py-12 px-6 sm:px-12">
        <div class="max-w-4xl w-full bg-white rounded-xl shadow-lg">
            <!-- Header Section -->
            <div class="bg-gradient-to-r from-blue-900 to-blue-700 p-4 sm:p-6 text-center text-white rounded-lg">

                <div class="flex items-center justify-center mb-4">
                    <!-- Verified Icon -->
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8 text-white rounded-full p-1 mr-2" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <h1 class="text-xl sm:text-2xl font-bold text-white">Verify Your Identity</h1>
                </div>
                <p>Upload a clear photo of yourself holding your ID or passport. Your information will remain secure and private.</p>
            </div>
            ...
            <form id="uploadForm" 
                ...
                <div class="flex justify-center mt-4">
                    <button type="submit" class="relative inline-flex items-center justify-center p-0.5 mb-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-blue-900 to-blue-700 hover:text-white focus:ring-4 focus:outline-none">
